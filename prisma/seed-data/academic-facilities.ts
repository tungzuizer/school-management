...
export async function seedAcademicAndFacilities(
  ...
  // 4. Mục tiêu chất lượng năm học 2026-2027 (Quality Objectives - 10 Chỉ tiêu chi tiết)
  const qualityObjectives = [
    {
      code: "MTCL-2026-01",
      title: "Huy động trẻ 6 tuổi vào lớp 1 và duy trì sĩ số 6-11 tuổi đạt 100%",
      metricName: "Tỷ lệ huy động và duy trì sĩ số",
      targetValue: 100.0,
      actualValue: 99.8,
      unit: "%",
    ...
    {
      code: "MTCL-2026-03",
      title: "Tỷ lệ học sinh lớp 5 hoàn thành chương trình tiểu học đạt 100%",
      metricName: "Tỷ lệ hoàn thành CTTH Lớp 5",
      targetValue: 100.0,
      actualValue: 100.0,
      unit: "%",
    ...
    {
      code: "MTCL-2026-04",
      title: "Khen thưởng học sinh Xuất sắc và Tiêu biểu cuối năm đạt trên 65%",
      metricName: "Tỷ lệ khen thưởng theo Thông tư 27/2020",
      targetValue: 65.0,
      actualValue: 63.5,
      unit: "%",
      status: QualityObjectiveStatus.NEAR_TARGET,
    ...
    {
      code: "MTCL-2026-05",
      title: "100% học sinh khuyết tật hòa nhập (37 HS) được xây dựng kế hoạch cá nhân & đánh giá tiến bộ",
      metricName: "Tỷ lệ học sinh hòa nhập có kế hoạch cá nhân",
      targetValue: 100.0,
      actualValue: 100.0,
      unit: "%",
      status: QualityObjectiveStatus.ACHIEVED,
    ...
    {
      code: "MTCL-2026-06",
      title: "100% khối lớp triển khai bài học STEM và hoạt động trải nghiệm STEM",
      metricName: "Tỷ lệ lớp học thực hiện bài học STEM",
      targetValue: 100.0,
      actualValue: 96.0,
      unit: "%",
      status: QualityObjectiveStatus.NEAR_TARGET,
    ...
    {
      code: "MTCL-2026-07",
      title: "100% học sinh khối 3, 4, 5 được học Ngoại ngữ 1 (Tiếng Anh) và Tin học bắt buộc",
      metricName: "Tỷ lệ học sinh khối 3-5 học Tiếng Anh và Tin học",
      targetValue: 100.0,
      actualValue: 100.0,
      unit: "%",
      status: QualityObjectiveStatus.ACHIEVED,
    ...
    {
      code: "MTCL-2026-08",
      title: "100% CB-GV ứng dụng Chuyển đổi số, Học bạ số, Sổ điểm và Giáo án điện tử",
      metricName: "Tỷ lệ áp dụng Học bạ số và Sổ điện tử toàn trường",
      targetValue: 100.0,
      actualValue: 97.5,
      unit: "%",
      status: QualityObjectiveStatus.ACHIEVED,
    ...
    {
      code: "MTCL-2026-09",
      title: "Đội ngũ CB-GV đạt chuẩn trình độ đào tạo Đại học trở lên đạt trên 95%",
      metricName: "Tỷ lệ CB-GV đạt chuẩn Đại học theo Luật GD 2019",
      targetValue: 95.8,
      actualValue: 94.2,
      unit: "%",
      status: QualityObjectiveStatus.NEAR_TARGET,
    ...
    {
      code: "MTCL-2026-10",
      title: "Tỷ lệ giáo viên dạy giỏi cấp trường đạt từ 80% trở lên",
      metricName: "Tỷ lệ giáo viên dạy giỏi cấp trường",
      targetValue: 80.0,
      actualValue: 82.5,
      unit: "%",
      status: QualityObjectiveStatus.ACHIEVED,
