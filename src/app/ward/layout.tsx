...
const tagStyles = {
  cyan: "bg-cyan-100/90 text-cyan-800 border-cyan-300/80 font-bold",
  sky: "bg-sky-100/90 text-sky-800 border-sky-300/80 font-bold",
};

const codeBadgeStyles = {
  cyan: "bg-gradient-to-r from-cyan-500 to-sky-600 text-white border-cyan-400/40 shadow-xs font-black",
...
const cardAccentStyles = {
  cyan: "border-cyan-300/60 hover:border-cyan-400/90 bg-gradient-to-r from-cyan-100/70 via-sky-50/60 to-blue-50/60 hover:from-cyan-200/80 hover:to-sky-100/80 backdrop-blur-md shadow-xs shadow-cyan-500/5",
