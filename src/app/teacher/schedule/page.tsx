    ...
    <div className="space-y-3.5 sm:space-y-5 max-w-7xl mx-auto px-1 sm:px-4 pb-28 lg:pb-8">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              {data?.homeroomClassName && (
                <span className="px-2.5 py-0.5 bg-amber-400/30 border border-amber-300/40 rounded-full text-amber-100 text-[10px] sm:text-[11px] font-black">
            ...
            <p className="text-[10.5px] sm:text-xs text-emerald-100/90 truncate">
              {viewScope === "HOMEROOM"
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-2 bg-white/90 backdrop-blur-xl border border-emerald-200/70 p-1.5 rounded-2xl shadow-xs">
        <div className="flex items-center gap-1 w-full sm:w-auto">
          <button
            ...
            className={`flex-1 sm:flex-initial px-2.5 sm:px-3 py-1.5 rounded-xl text-[11px] sm:text-xs font-extrabold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
              viewScope === "PERSONAL"
        ...
        <div className="flex items-center gap-1 w-full sm:w-auto justify-between sm:justify-end">
          ...
          <Link
            ...
            className="px-2.5 sm:px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-[11px] sm:text-xs font-extrabold flex items-center gap-1.5 transition-colors shadow-xs"
          >
      ...
      {loading ? (
        ...
        <div className="space-y-3">
            ...
            {daysToRender.map((d) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-[9px] sm:text-[10px] font-bold mt-0.5 ${isSelected ? "text-emerald-100" : "text-slate-500"}`}>
                    {d.formattedDate}
                  </span>
          ...
          {/* Selected Day Header Info */}
          <div className="px-3 py-1.5 sm:py-2 bg-gradient-to-r from-emerald-50 via-teal-50/50 to-cyan-50 border border-emerald-200/80 rounded-xl flex items-center justify-between text-[11px] sm:text-xs">
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-emerald-950">
                {currentDayHeader?.label} ({currentDayHeader?.formattedDate})
              </span>
              {currentDayHeader?.isToday && (
                <span className="px-1.5 sm:px-2 py-0.5 bg-emerald-600 text-white rounded-md text-[9px] sm:text-[10px] font-black">
                  HÔM NAY
                </span>
              )}
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2.5 sm:gap-3">
                      ...
                      <span className="text-[10.5px] sm:text-xs italic">— Tiết trống (Không có lịch dạy) —</span>
                    </div>
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-2 sm:gap-2.5">
                      ...
                      <div>
                        <div className="flex items-center gap-1.5 sm:gap-2">
                          ...
                          <span className="px-1.5 sm:px-2 py-0.5 rounded text-[9.5px] sm:text-[10px] font-black bg-emerald-100 text-emerald-800 border border-emerald-200">
                            Lớp {slot.className}
                          </span>
                    ...
                    <div className="flex flex-col items-end gap-1">
                      ...
                      {slot.isAttendanceDone ? (
                        ...
                        <Link
                          href="/teacher/attendance"
                          className="inline-flex items-center gap-1 text-[9.5px] sm:text-[10px] font-extrabold text-amber-700 bg-amber-100 hover:bg-amber-200 px-1.5 sm:px-2 py-0.5 rounded-md border border-amber-300 transition-colors"
                        >
